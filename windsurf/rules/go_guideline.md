...
- **Categorization (Go Build Tags & Libraries):**
    ...
    - **End-to-End (E2E) / Integration Tests (`//go:build e2e`):**
        - For cucumber-like test structure guidance without specific libraries (e.g. Godog), AI Agent MUST refer to patterns in `github.com/bmcszk/effective-monorepo/tree/feature/tilt/e2e`.
